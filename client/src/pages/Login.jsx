  ...
  return (
    <>
          <div className="flex flex-col justify-center md:flex-row h-screen">
              ...
              <div className="max-w-sm w-full">
                ...
                <form onSubmit={handleLogIn}>
                  ...
                  <div className="block md:hidden font-semibold mt-5">
                    <p>New to the platform? <Link to={"/register"} className="text-sm text-gray-500 hover:underline">Sign Up</Link></p>
                  </div>
            ...
            {/* RIGHT SIDE */}
            <div className="hidden w-full md:w-1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tl-[80px] prunded-bl-[80px]">
