      ...
      <div className="flex flex-col justify-center md:flex-row h-screen">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8">
          <div className="w-full max-w-sm">
            ...
            <p className="text-gray-500 text-center mb-12">Please provide your information to sign up.</p>
            ...
            <div className="mb-2">
              <input type="text" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email" className="w-full px-4 py-3 border border-black rounded-md focus:outline-none" />
            </div>
